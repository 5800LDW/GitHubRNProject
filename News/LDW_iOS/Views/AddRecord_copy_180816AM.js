        ...
        return (
            <View style={styles.container}>
                ...
                <ScrollView style={{flex: 1 , marginBottom:1}}
                    ...
                    {/*onPress={()=>{this.refs.scrollView.scrollTo({x:0,y:100,animated:true});}}*/}
                    {/*>*/}
                    {/*Hello World*/}
                    ...
                    {/*<Text style={styles.textStyle}*/}
                    {/*onPress={*/}
                    {/*() => this.RequestOddNumbers(new Const().getOddNumber, this)}*/}
                    {/*>生成单号：</Text>*/}
                    ...
                    {/*editable={false}*/}
                    {/*onChangeText={*/}
                    {/*(input) => this.setState({oddNumbers: input})}*/}

                    {/*></TextInput>*/}
                    {/*</View>*/}

                    {/*<View style={styles.item}>*/}
                    {/*<Text style={styles.textStyle}>生成单号：</Text>*/}
                    ...
                    {/*autoCapitalize="none"*/}
                    {/*onChangeText={*/}
                    {/*(input) => this.setState({oddNumbers: input})}></TextInput>*/}
                    {/*</View>*/}
                        ...
                        {this.state.images != null && this.state.images.length >= 5 ?
                            ...
                            <View style={styles.button}>
                                <TouchableOpacity
                                    ...
                                    <Image style={{width:128,height:128}} source={require('../../resource/drawable/image_add.png')}></Image>
                                </TouchableOpacity>


                                {/*<ScrollView>*/}
                                {/*<TouchableOpacity onPress={() => this.pickSingle(false)} style={styles.button}>*/}
                                {/*<Text style={styles.text}>从相册选择单个图片</Text>*/}
                                {/*</TouchableOpacity>*/}
                    ...
                    {/*{this.state.images!=null&&this.state.images.length>=5?*/}
                    {/*null: <Image  ><Text>我是图片</Text></Image>*/}
                    {/*}*/}
