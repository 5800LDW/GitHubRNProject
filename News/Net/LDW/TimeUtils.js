 ...
 *
 * 使用方法:
 * 1.TimeUtils.formatDate(new Date().getTime(), "yyyy-MM-dd hh:mm:ss")
 * 2.TimeUtils.formatDate"yyyy-MM-dd hh:mm:ss")
 *
 *
 *
 */
class TimeUtils extends Component {
    ...
    static formatCurrentDate(formater){
       return TimeUtils.formatDate(new Date().getTime(),formater);
    }
